...
Once the `conda-forge` channel has been enabled, `sphinxcontrib-jsmath` can be installed with:

```
conda install sphinxcontrib-jsmath
```

It is possible to list all of the versions of `sphinxcontrib-jsmath` available on your platform with:
